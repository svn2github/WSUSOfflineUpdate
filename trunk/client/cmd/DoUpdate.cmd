...
set WSUSOFFLINE_VERSION=11.1.1b (r921)
title %~n0 %*
...
if "%OS_NAME%"=="w60" (
  ...
  set DOTNET4_FILENAME=..\dotnet\NDP471-KB4033342-x86-x64-AllOS-ENU.exe
  set DOTNET4LP_FILENAME=..\dotnet\NDP471-KB4033342-x86-x64-AllOS-%OS_LANG%.exe
)
if "%OS_SRV_CORE%"=="1" (
