...
set WSUSOFFLINE_VERSION=8.4b (r466)
...
for %%i in (w60 w60-x64 w61 w61-x64 w62 w62-x64 ofc o2k13) do (
  if /i "%1"=="%%i" (
...
echo Usage2: %~n0 {w60 ^| w60-x64 ^| w61 ^| w61-x64 ^| w62 ^| w62-x64 ^| ofc ^| o2k13} {glb} [/excludesp ^| /excludestatics] [/includedotnet] [/includemsse] [/includewddefs] [/nocleanup] [/verify] [/skiptz] [/skipdownload] [/skipdynamic] [/proxy http://[username:password@]^<server^>:^<port^>] [/wsus http://^<server^>] [/wsusonly] [/wsusbyproxy]
