...
find ../exclude/ -type f -exec dos2unix -q "{}" + 2>&1 \; || echo find has a problem with exclude
find ../xslt/ -type f -exec dos2unix -q "{}" + 2>&1 \; || echo find has a problem with xslt
find ../static/ -type f -exec dos2unix -q "{}" + 2>&1 \; || echo find has a problem with static
