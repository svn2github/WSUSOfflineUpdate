...
set TSC_VERSION_TARGET_BUILD=0
set TSC_VERSION_TARGET_REVISION=0

set DOTNET35_VERSION_TARGET_MAJOR=3
set DOTNET35_VERSION_TARGET_MINOR=5
set DOTNET35_VERSION_TARGET_BUILD=30729
set DOTNET35_VERSION_TARGET_REVISION=1

set DOTNET4_VERSION_TARGET_MAJOR=4
set DOTNET4_VERSION_TARGET_MINOR=0
set DOTNET4_VERSION_TARGET_BUILD=30319
set DOTNET4_VERSION_TARGET_REVISION=0
...
set WSH_VERSION_TARGET_MINOR=7
...
set WMP_VERSION_TARGET_MAJOR=0
if /i "%OS_ARCHITECTURE%"=="x64" (
  set TSC_VERSION_TARGET_MAJOR=5
  set TSC_VERSION_TARGET_MINOR=2
) else (
  set TSC_VERSION_TARGET_MAJOR=6
...
set WSH_VERSION_TARGET_MAJOR=5
set WSH_VERSION_TARGET_MINOR=8
...
:NoO2k7
if "%O2K10_VERSION_MAJOR%"=="" goto NoO2k10
rem *** Office 2010 ***
set OFFICE_NAME=o2k10
set OFFICE_LANGUAGE=%O2K10_LANGUAGE%
set O2K10_SP_VERSION_TARGET=0
:NoO2k10
goto EoF
